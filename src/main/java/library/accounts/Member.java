...
public class Member extends Account {
    ...
    // A'zo nechta kitob ola olishi
    private static final int MAX_BOOKS_LIMIT = 5;

    // Hozirda olingan kitoblar ro'yxati
    ...
    /**
     * Kitob olish (checkout).
     * Use Case: "Checkout book" -> "Issue book" (include)
     */
    public boolean checkoutBookItem(BookItem bookItem) {
        ...
        // 3. Kitob checkout qilish
        if (bookItem.checkout()) {
            // 14 kunlik muddatni belgilash
            ...
            // Agar bu kitobni avval zahiralagan bo'lsak - zahirani yakunlaymiz
